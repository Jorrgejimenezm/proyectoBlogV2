    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categorias', models.ManyToManyField(to='BlogV2.categoria', verbose_name='Categorías')),
            ],
            options={
                'ordering': ['-creado'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('articulo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='BlogV2.articulo')),
            ],
            options={
                'ordering': ['-creado'],
            },
